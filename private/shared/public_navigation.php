<?php
  ...
  $visible= $visible ?? true; //visible = visible,default is true
?>

<navigation>
  <?php $nav_subjects = find_all_subject(['visible'=>$visible]); ?>
  <ul class="subjects">
    <?php while($nav_subject = mysqli_fetch_assoc($nav_subjects)) { ?>
    <!-- check if if subject is visible. If visible display else got hide from public facing pages -->
