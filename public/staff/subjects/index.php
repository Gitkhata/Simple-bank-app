...
require_login();
//Separating single query into multiple line
$sql ="SELECT * FROM subjects "; //space is important here for concatination
        ...
        <table class="list">
            <tr>
                ...
                <th>&nbsp;</th>
                 ...
                 <!-- unitl the result can be fetched go through each one -->
                 <!-- this is not a comaprison -->
