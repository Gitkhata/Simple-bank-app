...
<?php
require_login();
// if page value is not sent then 1 will be the default page
  //$id = isset($_GET['id]) ? $_GET['id]:'1'; //use of ternary operatior
...
<!-- <a href ="show.php?name = <?php echo u('John Wick');?>" > Link </a></br>
<a href ="show.php?company = <?php echo u('Jeevan&Company');?>" > Link </a></br>
      ...
      <div class="Pages listing">
        ...
        <table class="list">
            ...
            <tr>
                ...
                //encode url as well as check to control dynamic value
