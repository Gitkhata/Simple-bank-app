...
//if visible = true don't display prview.Else display preview link
//if visible = true, preview will be false
//if preview =true, visible will be false
$visible =!$preview;
  ...
  <div id="page">
    ...
    <?php
      if(isset($page)) {
        ...
        //strip all the html character which are not included in the variables
        $allowed_tags ='<div><img><h1><h2><p><br><strong><emp>,<u><li>';
